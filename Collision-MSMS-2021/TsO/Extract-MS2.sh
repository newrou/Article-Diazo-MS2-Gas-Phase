...
FileFilter -in tmp-ms2.mzML -out tmp-ms2-pk2.mzML -pc_mz 471.05:471.09 -spectra:select_activation 'Collision-induced dissociation' -int 100: -rt :1500 -mz :700
FileConverter -in tmp-ms2-pk2.mzML -out $in-pk2-ms2.dta2d
#php Integrate-MS2.php tmp-ms2.dta2d > tmp-ms2.dat
#gnuplot Plot-Integrated-MS2.gnu
