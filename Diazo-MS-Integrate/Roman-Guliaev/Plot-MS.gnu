...
set arrow from 0,0 to 500,50 as 2
set label "(A)" at 500,50 center font "Helvetica,20"
set arrow from 150,70 to 122,70 as 3
set label "-28 [N2]" at 60,75 center font "Helvetica,20"

set output 'tmp-ms.svg'
plot 'tmp-ms.dat' using 2:4 with impulses lw 5 lc -1
