...
#set key outside
set nokey
set output 'GR-N4-neg.svg'
set label "62.0" at 61.99,102.00 center tc rgb "red" font ",17"
set label "167.0" at 167.00,18.20 center tc rgb "red" font ",17"
set arrow from 167.00,0 to 167.00,110 as 2
set label "225.9" at 225.93,21.00 center tc rgb "red" font ",17"
plot 'GR-N4-neg.dat' using 2:4 with impulses lw 5 lc -1
quit
