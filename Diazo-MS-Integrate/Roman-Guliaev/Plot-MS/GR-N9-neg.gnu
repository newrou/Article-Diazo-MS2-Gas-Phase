...
#set key outside
set nokey
set output 'GR-N9-neg.svg'
set label "A" at 148.95,102.00 center tc rgb "red" font ",17"
set arrow from 148.95,0 to 148.95,110 as 2
set arrow from 820.91,0 to 820.91,110 as 2
set arrow from 148.95,40.00 to 820.91,40.00 as 3
set arrow from 148.95,40.00 to 820.91,40.00 as 3
set label "+[M]" at 484.93,43.00 center tc rgb "black" font ",17"
set arrow from 1492.88,0 to 1492.88,110 as 2
set arrow from 820.91,40.00 to 1492.88,40.00 as 3
set arrow from 820.91,40.00 to 1492.88,40.00 as 3
set label "+[M]" at 1156.90,43.00 center tc rgb "black" font ",17"
set arrow from 2164.84,0 to 2164.84,110 as 2
set arrow from 1492.88,40.00 to 2164.84,40.00 as 3
set arrow from 1492.88,40.00 to 2164.84,40.00 as 3
set label "+[M]" at 1828.86,43.00 center tc rgb "black" font ",17"
set arrow from 2836.80,0 to 2836.80,110 as 2
set arrow from 2164.84,40.00 to 2836.80,40.00 as 3
set arrow from 2164.84,40.00 to 2836.80,40.00 as 3
set label "+[M]" at 2500.82,43.00 center tc rgb "black" font ",17"
plot 'GR-N9-neg.dat' using 2:4 with impulses lw 5 lc -1
quit
