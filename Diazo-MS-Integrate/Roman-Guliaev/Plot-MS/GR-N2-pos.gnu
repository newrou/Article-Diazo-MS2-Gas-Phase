...
#set key outside
set nokey
set output 'GR-N2-pos.svg'
set label "DC" at 150.03,102.00 left tc rgb "red" font ",17"
set label "AC" at 122.03,102.00 right tc rgb "red" font ",17"
...
set label "243.1" at 243.13,20.90 right tc rgb "red" font ",17"
...
set arrow from 1936.22,0 to 1936.22,110 as 2
set arrow from 1603.20,90.00 to 1936.22,90.00 as 3
set arrow from 1603.20,90.00 to 1936.22,90.00 as 3
set label "+[M]" at 1769.71,93.00 center tc rgb "black" font ",17"
set arrow from 150.03,65.00 to 271.13,65.00 as 3
set label "+121.1" at 210.58,68.00 center tc rgb "black" font ",17"
plot 'GR-N2-pos.dat' using 2:4 with impulses lw 5 lc -1
quit
