...
#set key outside
set nokey
set output 'GR-N8-neg.svg'
set label "A" at 148.95,102.00 center tc rgb "red" font ",17"
set arrow from 148.95,0 to 148.95,110 as 2
set arrow from 645.06,0 to 645.06,110 as 2
set arrow from 148.95,40.00 to 645.06,40.00 as 3
set arrow from 148.95,40.00 to 645.06,40.00 as 3
set label "+[M]" at 397.01,43.00 center tc rgb "black" font ",17"
set arrow from 1141.17,0 to 1141.17,110 as 2
set arrow from 645.06,40.00 to 1141.17,40.00 as 3
set arrow from 645.06,40.00 to 1141.17,40.00 as 3
set label "+[M]" at 893.11,43.00 center tc rgb "black" font ",17"
set arrow from 1637.27,0 to 1637.27,110 as 2
set arrow from 1141.17,40.00 to 1637.27,40.00 as 3
set arrow from 1141.17,40.00 to 1637.27,40.00 as 3
set label "+[M]" at 1389.22,43.00 center tc rgb "black" font ",17"
plot 'GR-N8-neg.dat' using 2:4 with impulses lw 5 lc -1
quit
