...
#set key outside
set nokey
set output 'GR-N7-neg.svg'
set label "A" at 148.95,102.00 center tc rgb "red" font ",17"
set arrow from 148.95,0 to 148.95,110 as 2
set arrow from 478.98,0 to 478.98,110 as 2
set arrow from 148.95,40.00 to 478.98,40.00 as 3
set arrow from 148.95,40.00 to 478.98,40.00 as 3
set label "+[M]" at 313.97,43.00 center tc rgb "black" font ",17"
set arrow from 809.01,0 to 809.01,110 as 2
set arrow from 478.98,40.00 to 809.01,40.00 as 3
set arrow from 478.98,40.00 to 809.01,40.00 as 3
set label "+[M]" at 643.99,43.00 center tc rgb "black" font ",17"
set arrow from 1139.04,0 to 1139.04,110 as 2
set arrow from 809.01,40.00 to 1139.04,40.00 as 3
set arrow from 809.01,40.00 to 1139.04,40.00 as 3
set label "+[M]" at 974.02,43.00 center tc rgb "black" font ",17"
set arrow from 1469.07,0 to 1469.07,110 as 2
set arrow from 1139.04,40.00 to 1469.07,40.00 as 3
set arrow from 1139.04,40.00 to 1469.07,40.00 as 3
set label "+[M]" at 1304.05,43.00 center tc rgb "black" font ",17"
plot 'GR-N7-neg.dat' using 2:4 with impulses lw 5 lc -1
quit
