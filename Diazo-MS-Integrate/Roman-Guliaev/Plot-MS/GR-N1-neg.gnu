...
#set key outside
set nokey
set output 'GR-N1-neg.svg'
set label "62.0" at 61.99,85.20 center tc rgb "red" font ",17"
...
set label "183.0" at 182.99,7.40 center tc rgb "red" font ",17"
set arrow from 182.99,0 to 182.99,110 as 2
set arrow from 516.01,0 to 516.01,110 as 2
set arrow from 182.99,40.00 to 516.01,40.00 as 3
set arrow from 182.99,40.00 to 516.01,40.00 as 3
set label "+[M]" at 349.50,43.00 center tc rgb "black" font ",17"
set arrow from 849.03,0 to 849.03,110 as 2
set arrow from 516.01,40.00 to 849.03,40.00 as 3
set arrow from 516.01,40.00 to 849.03,40.00 as 3
set label "+[M]" at 682.52,43.00 center tc rgb "black" font ",17"
set arrow from 1182.04,0 to 1182.04,110 as 2
set arrow from 849.03,40.00 to 1182.04,40.00 as 3
set arrow from 849.03,40.00 to 1182.04,40.00 as 3
set label "+[M]" at 1015.53,43.00 center tc rgb "black" font ",17"
set label "125.0" at 124.99,61.60 center tc rgb "red" font ",17"
set label "286.1" at 286.06,80.00 center tc rgb "red" font ",17"
plot 'GR-N1-neg.dat' using 2:4 with impulses lw 5 lc -1
quit
